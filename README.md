...
A book cover examples, which have been achieved by using modified by suggested method GAN model. 
...
## Web architecture
For the future web release the following architecture has been suggested.
